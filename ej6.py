"""6) Vamos a definir ahora una “Cuenta Joven”, para ello vamos a crear una
...
de edad., por lo tanto hay que crear un método esTitularValido() que
devuelve verdadero si el titular es mayor de edad pero menor de 25
